# Generated by Django 4.0.6 on 2022-07-08 08:14
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('relation_number', models.IntegerField(unique=True)),
                ('institution', models.CharField(blank=True, max_length=20, null=True, verbose_name='Educational institution')),
                ('programme', models.CharField(blank=True, max_length=20, null=True, verbose_name='Study programme')),
                ('student_number', models.CharField(blank=True, max_length=8, null=True, unique=True, validators=[django.core.validators.RegexValidator(message='Enter a valid student- or e/z/u-number.', regex='(s\\d{7}|[ezu]\\d{6,7})')], verbose_name='Student number')),
                ('RSC_number', models.CharField(blank=True, max_length=9, null=True, unique=True, verbose_name='RSC card number')),
                ...
                ('profile_description', models.TextField(blank=True, help_text='Text to display on your profile', max_length=4096, null=True, verbose_name='Profile text')),
                ...
                ('receive_newsletter', models.BooleanField(default=True, help_text='Receive the Thalia Newsletter', verbose_name='Receive newsletter')),
